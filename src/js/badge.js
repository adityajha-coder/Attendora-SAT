...
export function checkAchievements(courseName = null) {
...
export function generateSemesterWrapped() {
    ...
    if (termHistory.length < 5) {
        ...
        toggleModal(document.getElementById('semester-wrapped-modal'), true);
        return;
    }
...
export function shareSemesterWrapped() {
